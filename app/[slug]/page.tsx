...
export default async function ServicePage({
    ...
    // This is a catch-all for potential conflicts with static routes
    const staticRoutes = ["about", "contact", "services", "blog", "not-found", "api", "_next"]
    if (staticRoutes.includes(slug)) return notFound()
